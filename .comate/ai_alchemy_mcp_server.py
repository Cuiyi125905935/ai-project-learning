...
class AIAAlchemyGovernanceServer:
    ...
    def validate_and_fix_python(self, code_snippet: str) -> str:
        ...
        try:
            ...
            result = subprocess.run(
                ["ruff", "check", "--fix", temp_file], capture_output=True, text=True
            )
    ...
    def pre_check_backtrader_logic(self, strategy_code: str) -> bool:
        ...
        checks = [
            ...
            "self.buy" in strategy_code
            or "self.sell" in strategy_code,  # Must have actions
    ...
    def process_generation_request(
        self, request_type: str, content: str
    ) -> Dict[str, Any]:
